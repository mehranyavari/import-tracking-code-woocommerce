<?php
/*
Plugin Name: Import Tracking Code Woocommerce
Plugin URI: https://buy.iprocode.com/
Description: Import Tracking Code Woocommerce
Author: Mehran Yavari
Author URI: https://mehranyavari.ir/
Text Domain: import_tracking_code
Version: 1.0
*/
...
class Import_Tracking_Code
{
    ...
    public function options_page()
    {
        ...
        // add_submenu_page('catalog-product', 'Catalog Product Woocommerce', __('Catalog Product Woocommerce','catalog_product'),'manage_options', 'catalog-product-settings', array($this,'settings_page_html'));
    }
    public function settings_page_html()
    {
        ...
        if (isset($_FILES['file'])) {
            if ($xlsx = $this->parse($_FILES['file']['tmp_name'])) {
                ...
                foreach ($rows as $r) {
                    update_post_meta($r['order'], '_tracking_code', $r['code']);
                }
                echo '<div class="notice notice-success">
      <p>کد رهگیری ها با موفقیت وارد شدند</p>
      </div>';
            } else {
                echo $this->parseError();
            }
        }
        echo '<h2>فایل اکسل را اپلود کنید</h2>
        <form method="post" enctype="multipart/form-data">
        *.XLSX <input type="file" name="file"  />&nbsp;&nbsp;<input type="submit" value="import" />
        </form>';
    }
...
$import_tracking_code = new Import_Tracking_Code();
